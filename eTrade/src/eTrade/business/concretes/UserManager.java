...
public class UserManager implements UserService {
	...
	public void add(User user) throws Exception {
		...
		checkIfUserFirstNameIsEmpty(user);
		checkIfUserLastNameIsEmpty(user);
	...
	private void checkIfUserFirstNameIsEmpty(User user) throws Exception {
	...
	private void checkIfUserLastNameIsEmpty(User user) throws Exception {
		if(user.getLastName()==null) {
			throw new Exception();
		}
		
	}
	private void checkIfUserPasswordIsEmpty(User user) throws Exception {
	...
	private void checkIfUserEmailIsEmpty(User user) throws Exception {
	...
	private boolean checkIfVerificationLinkClick(User user) {
		boolean state=true;
		if(state) {
			System.out.println("Email dogrulandi.");
			
		}else {
			System.out.println("Email doğrulanmadi.");
		}
		return state;
	}
	
	private void checkIfAccountVerificate(User user) throws Exception {
		
		if(!checkIfVerificationLinkClick(user)) {
			throw new Exception();
		}
	}
